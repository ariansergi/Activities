...
export default function ActivityDashboard({activities,selectActivity,selectedActivity,cancelSelectActivity,submitting, editMode,openForm,closeForm,createOrEdit,deleteActivity}: Props) {
    return (
        <Grid>
